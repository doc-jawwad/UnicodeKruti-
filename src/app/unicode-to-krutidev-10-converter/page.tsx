        ...
        <div className="container hero-container">
          <div className="hero-content u2k10-hero-content">
            ...
            >
              ...
              Tools, or InScript, directly into KrutiDev 10 (also called Kurtidev10) encoding. Paste
              your text, get KrutiDev 10 output in seconds. No software to install. No signup. Runs
              entirely in your browser. Designed for exam candidates, coaching institutes, and DTP
              professionals who need the reverse of the standard conversion direction.
            </p>
          </div>
