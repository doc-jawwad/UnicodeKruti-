...
export const k010Faqs = [
  ...
  },
  {
    ...
    answer:
      'KrutiDev 011 is a bold variant of KrutiDev 010. Both use the same underlying character encoding; the only difference is stroke weight. If you have KrutiDev 011 text, the same KrutiDev 010 character mapping applies, and this converter will process it correctly.',
  },
  {
